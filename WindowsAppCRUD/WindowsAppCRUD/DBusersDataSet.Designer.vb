    ...
    Partial Public Class UtilizadoresTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Utilizadores] SET [ID] = @ID, [nome] = @nome, [utilizador] = @utili"& _ 
                ...
                "riginal_senha) AND ([nivel] = @Original_nivel));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, nome, utilizador, s"& _ 
                "enha, nivel FROM Utilizadores WHERE (ID = @ID)"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_nome As String, ByVal Original_utilizador As String, ByVal Original_senha As String, ByVal Original_nivel As Boolean) As Integer
            ...
            End If
            Me.Adapter.DeleteCommand.Parameters(4).Value = CType(Original_nivel,Boolean)
        ...
        Public Overloads Overridable Function Insert(ByVal ID As Integer, ByVal nome As String, ByVal utilizador As String, ByVal senha As String, ByVal nivel As Boolean) As Integer
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(4).Value = CType(nivel,Boolean)
        ...
        Public Overloads Overridable Function Update(ByVal ID As Integer, ByVal nome As String, ByVal utilizador As String, ByVal senha As String, ByVal nivel As Boolean, ByVal Original_ID As Integer, ByVal Original_nome As String, ByVal Original_utilizador As String, ByVal Original_senha As String, ByVal Original_nivel As Boolean) As Integer
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(4).Value = CType(nivel,Boolean)
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_nivel,Boolean)
